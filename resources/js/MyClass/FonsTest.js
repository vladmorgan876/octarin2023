...
//     //----------------------------
//     //------ sun 2  ------------------
//     // var geometrySun2 = new THREE.SphereGeometry(.51, 32, 32);
//     // const loaderImageSun2 = new THREE.TextureLoader();
//     // var materialSun2 = new THREE.MeshPhongMaterial({wireframe:false, map: loaderImageSun2.load('/storage/newimage/sun1.jpg'),opacity:0.2, transparent: true});
//     // var Sun2 = new THREE.Mesh( geometrySun2, materialSun2 );
//     // Sun2.position.set(0,-0.1,-1)
//     // scene.add(Sun2)
// //-------------- sun 1  ----------------------
// //     var geometrySun1 = new THREE.SphereGeometry(.5, 32, 32);
// //     const loaderImageSun1 = new THREE.TextureLoader();
// //     //var material = new THREE.MeshPhongMaterial({wireframe:false, map: loaderImage.load('/storage/newimage/newearth.jpg')});
// //     var materialSun1 = new THREE.MeshPhongMaterial({wireframe:false, map: loaderImageSun1.load('/storage/newimage/sun2.jpg')
// //     });
// //     var Sun1 = new THREE.Mesh( geometrySun1, materialSun1 );
// //     Sun1.position.set(-0,-0.1,-1)
// //     scene.add( Sun1 );
//  //--------------------------------------------
//     //---------  mercury ----------
//     // var geometrymercury = new THREE.SphereGeometry(.05, 32, 32);
//     // const loaderImagemercury = new THREE.TextureLoader();
//     // var materialmercury = new THREE.MeshPhongMaterial({wireframe:false, map: loaderImagemercury.load('/storage/newimage/mercury.jpg')});
//     // var mercury = new THREE.Mesh( geometrymercury, materialmercury );
//     // mercury.position.set(-1,-0,-1)
//     // Sun1.add(mercury)
//     //------------------------------
//     //--------- venus -------------
//     // var geometryvenus = new THREE.SphereGeometry(.2, 32, 32);
//     // const loaderImagevenus = new THREE.TextureLoader();
//     // var materialvenus = new THREE.MeshPhongMaterial({wireframe:false, map: loaderImagevenus.load('/storage/newimage/venus.jpg')});
//     // var venus = new THREE.Mesh( geometryvenus, materialvenus );
//     // venus.position.set(5,0,-7)
//     // Sun1.add(venus)
//     //-----------------------------
// //   --------- earth   -------------
...
//    //     debugger;
//    //
//    //     if (Sun1.position.z>=0 && Sun1.position.z<29){
//    //         Sun1.position.z += .1;
//    //          Sun2.position.z += .1;
//    //         Sun1.position.x +=0.038;
//    //          Sun2.position.x +=0.038;
//    //         Sun1.rotation.y += 0.0;
//    //          Sun2.rotation.x -= 0.0;
//    //
//    //     }
//    //     if (Sun1.position.z>=29){
//    //         Sun1.rotation.y -= 0.001;
//    //          Sun2.rotation.x += 0.001;
//    //         Sun1.position.z -= .001;
//    //          Sun2.position.z -= .001;
...
//        // Sun2.position.x -= 0.01;
//        // earth.position.x -= 0.01;
//        // if(earth.position.x<=.5){
//        //
//        //     earth.position.x += 0.002;
//        //     earth.position.y += 0.001;
//        //     earth.position.z += 0.0001;
//        // }
//        // if(earth.rotation.y>=3){
//        //      moon.scale.set(0,0,0);
//        //      earth.children[1].scale.set(1,1,1);
